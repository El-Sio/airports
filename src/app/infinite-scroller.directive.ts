...
import { catchError, map, tap, switchMap, pairwise, filter, exhaustMap, startWith } from 'rxjs/operators';
...
export class InfiniteScrollerDirective implements AfterViewInit {
  ...
  private streamScrollEvents() {
    this.userScrolledDown$ = this.scrollEvent$.pipe(map((e: any): ScrollPosition => ({
